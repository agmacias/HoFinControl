...
CREATE TABLE `cuentas` (
  ...
  KEY `cuenta_usuario_idx` (`usuario`),
  CONSTRAINT `cuenta_usuario` FOREIGN KEY (`usuario`) REFERENCES `usuarios` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2020-11-10 20:04:19
