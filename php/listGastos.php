<div ng-controller="ListGastosController" ng-init="init()">
    <div class="content">
        <div class="container-fluid">
            <form>
                    ...
                    <div class="card card-margin">
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <select name="cuentas" id="cuentas" ng-model="listGastosView.cuenta" class="form-control" accesskey="C" tabindex="1" multiple>
                            ...
                            <div class="form-group col-md-4">                                
                                ...
                                <select name="cuentas" id="cuentas" ng-model="listGastosView.tipoIngreso" class="form-control" accesskey="T" tabindex="2" multiple>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="input-group">
                                        <div class="col-md-3 custom-control custom-radio custom-control-inline">
                                          <input class="custom-control-input" type="radio" ng-model="listGastosView.agrupar" name="agrupar" id="cuenta" value="cuenta" accesskey="A" tabindex="6"/>
                                          <label class="custom-control-label pt-1" for="cuenta">
                                                Cuenta
                                          </label>
                                        </div>
                                        <div class="col-md-7 custom-control custom-radio custom-control-inline">
                                          <input class="custom-control-input" type="radio" ng-model="listGastosView.agrupar" name="agrupar" id="gasto" value="gasto" tabindex="7" accesskey="6" />
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="date" class="form-control" id="fecha" ng-model="listGastosView.fechaDesde" placeholder="Fecha desde" accesskey="D" tabindex="3" maxlength="12"/>
                            </div>
                            <div class="form-group col-md-4">
                                <label class ="cabeceraLabel" for="fecha">Fecha <u>H</u>asta:</label>
                                <input type="date" class="form-control" id="fecha" ng-model="listGastosView.fechaHasta" placeholder="Fecha hasta" accesskey="H" tabindex="4" maxlength="12"/>
                            </div>                            
                        </div>
                    </div>
                    <div class="form-row">
                ...
                <div class="row" ng-if="listGastosView.busqueda==1" id="table2excel">
