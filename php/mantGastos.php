<div ng-controller="MantGastosController" ng-init="init()">
    <div class="content">
        <div class="container-fluid">
            <form>
                <div class="login-form" ng-if="mantGastosView.pantalla==0">
                    <!-- inicio tarjetas -->
                    <div class="card card-margin">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="date" class="form-control" id="fecha" ng-model="mantGastosView.fechaDesde" placeholder="Fecha desde" accesskey="D" tabindex="3" maxlength="12"/>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                <label class ="cabeceraLabel" for="fecha">Fecha <u>H</u>asta:</label>
                                <input type="date" class="form-control" id="fecha" ng-model="mantGastosView.fechaHasta" placeholder="Fecha hasta" accesskey="H" tabindex="4" maxlength="12"/>
                            </div>
                            <div class="form-group col-md-8">
                                <label class ="cabeceraLabel" for="asunto"><u>A</u>sunto:</label>
                                <input type="text" class="form-control" id="asunto" ng-model="mantGastosView.asunto"  accesskey="A" tabindex="4" maxlength="50" placeholder='Asunto'/>
                            </div>
                        </div>
                    </div>
                    <div class="form-row">
                ...
                <div class="login-form" ng-if="mantGastosView.pantalla==1">
                    <!-- inicio tarjetas -->
                    <div class="card card-margin">
                        <div class="form-row">
                            <div class="form-group col-md-4">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="date" class="form-control" id="fecha" ng-model="mantGastosView.fecha" placeholder="Fecha" accesskey="I" tabindex="3" maxlength="12" required/>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-4">
                            ...
                            <div class="form-group col-md-8">
                                ...
                                <input type="text" class="form-control" id="asunto" ng-model="mantGastosView.asunto"  accesskey="A" tabindex="4" maxlength="50" placeholder='Asunto' required/>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <label class ="cabeceraLabel" for="descripcion"><u>D</u>escripción:</label>
                                <textarea class="form-control" id="descripcion" ng-model="mantGastosView.descripcion" maxlength="500" accesskey="D" rows="3" tabindex="5"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-12">
                            ...
                            <button type="submit" class="btn btn-primary btn-sm" id="nuevo" name="nuevo" tabindex="6" ng-click="mantGastosView.pantalla=0;operacion=1">Volver</button>
                        </div>
                    </div>
                </div>
            </form>
